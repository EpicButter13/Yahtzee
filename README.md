...
# 3
Yahtzee.cpp - Contains setup and main function with all logic related to circuit 
diceClass.cpp - Contains dice and diceset objects that handle rolls and scoring
